...
pub enum InterruptVector {
    ...
    PinChangeInterruptRequest1 = 4,
    PinChangeInterruptRequest2 = 5,
    WatchdogTimeOutInterrupt = 6,
    TimerCounter2CompareMatchA = 7,
    TimerCounter2CompareMatchB = 8,
    TimerCounter2Overflow = 9,
    TimerCounter1CaptureEvent = 10,
    TimerCounter1CompareMatchA = 11,
    TimerCounter1CompareMatchB = 12,
    TimerCounter1Overflow = 13,
    TimerCounter0CompareMatchA = 14,
    TimerCounter0CompareMatchB = 15,
    TimerCounter0Overflow = 16,
    SPISerialTransferComplete = 17,
    USARTRxComplete = 18,
    USARTDataRegisterEmpty = 19,
    USARTTxComplete = 20,
    ADCConversionComplete = 21,
    EEPROMReady = 22,
    AnalogComparator = 23,
    TwoWireSerialInterface = 24,
    StoreProgramMemoryRead = 25,
}
